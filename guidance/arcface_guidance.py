...
@threestudio.register("arcface-guidance")
class arcface_id(BaseObject):
    @dataclass
    ...
    def configure(self) -> None:
        weight = torch.load(self.cfg.arcface_path,'cpu')
    ...
    def __call__(self, rgb):
        # rgb: BCHW
        rgb_112 = F.interpolate(rgb, (112, 112), mode='bilinear', align_corners=False)
        feats = self.arcface(rgb_112)
...
if __name__ == '__main__':
    ...
    id_extract = arcface_id('cuda')
    fea = id_extract(input_tensor)
